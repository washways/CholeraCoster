...
function exportToCSV() {
    let csv = 'Malawi Cholera Cost Calculator Results\n';
...
function printResults() {
    ...
    html += '<h1>Malawi Cholera Cost-Benefit Analysis</h1>';
    ...
    html += '</table>';
    html += '<p style="margin-top: 20px; font-size: 0.9em; color: #666;"><em>Malawi Cholera Cost Calculator</em></p>';
    html += '</body></html>';
